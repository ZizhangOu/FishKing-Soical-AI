      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-300/10 hover:ring-gray-300/20">
              Experience Dating in the Future.{' '}
              <a href="#" className="font-semibold text-gray-300/10">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-white">
              AI Automatic Matching, Chating, Filtering, Arranging Dating App. Jump into the sea of Lover.
            </p>
